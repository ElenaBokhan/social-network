				...
				<div className = {headStyles.menu}>
					<nav>
						...
						<NavLink to = "/profile" 	className = {headStyles.menuItem} 
													activeClassName={headStyles.active}>Profile</NavLink>
