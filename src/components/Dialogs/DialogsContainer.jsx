...
import { getAllDialogs, sendMessage } from '../../store/DialogsReducer';
...
export const DialogsContainer = compose(connect(mapStateToProps, { getAllDialogs, sendMessage }), withoutAuthRedirect)(Dialogs)